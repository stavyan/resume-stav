<template>
  <div id="show-resume">
    <div id="resume_content" class="resume-content clearfloat"
         :style="{width:pfdSize.width+'px',height:pfdSize.height+'px'}">
      ...
      <section class="section-right">
        <div class="blog-box clearfloat">
          <div class="blog">
            ...
            <div class="link github"><i class="icon-github-alt icon-1x"></i>Github: <a target="_blank"
                                                                                       href="https://github.com/ZengTianShengZ">{{resumeData.blogLink.github}}</a>
            </div>
            <div class="link personal-blog"><i class="icon-flag icon-1x"></i>技术博文 <a target="_blank"
                                                                                     href="https://segmentfault.com/u/zss">{{resumeData.blogLink.blog}}</a>
            </div>
          </div>
        </div>
        ...
        <div class="experience project-experience">
          ...
          <div class="show" v-for="(item, index) in resumeData.projectExperience.experience" :key="index">
            <div class="item" v-if="item.name">
              ...
              <ul>
                <li v-for="(des, index) in item.describe" v-if="des!=''" :key="index">{{des}}</li>
              </ul>
            </div>
          </div>
        </div>
